...
Version  : 2.0.0
Release  : 21
URL      : https://files.pythonhosted.org/packages/6d/8c/b3256168e6591f583e76c28694a45323fc6a1527a2986b9554bc351aefa4/pyprojectx-2.0.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/6d/8c/b3256168e6591f583e76c28694a45323fc6a1527a2986b9554bc351aefa4/pyprojectx-2.0.0.tar.gz
...
%prep
%setup -q -n pyprojectx-2.0.0
cd %{_builddir}/pyprojectx-2.0.0
pushd ..
cp -a pyprojectx-2.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1704381125
